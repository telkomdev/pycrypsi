...
class TestAESCbc(unittest.TestCase):
    ...
    def test_encrypt_decrypt_aes128_cbc(self):
        ...
        result_encrypt = aes.encrypt_with_aes128_cbc_hex(key, bytes(data, 'utf-8'))
        self.assertIsNotNone(result_encrypt)

        result_decrypt = aes.decrypt_with_aes128_cbc_hex(key, result_encrypt)
    ...
    def test_encrypt_decrypt_aes192_cbc(self):
        ...
        result_encrypt = aes.encrypt_with_aes192_cbc_hex(key, bytes(data, 'utf-8'))
        self.assertIsNotNone(result_encrypt)

        result_decrypt = aes.decrypt_with_aes192_cbc_hex(key, result_encrypt)
    ...
    def test_encrypt_decrypt_aes256_cbc(self):
        ...
        result_encrypt = aes.encrypt_with_aes256_cbc_hex(key, bytes(data, 'utf-8'))
        self.assertIsNotNone(result_encrypt)

        result_decrypt = aes.decrypt_with_aes256_cbc_hex(key, result_encrypt)
