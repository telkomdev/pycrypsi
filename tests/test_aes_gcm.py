...
class TestAESGcm(unittest.TestCase):
    ...
    def test_encrypt_decrypt_aes128_gcm(self):
        ...
        result_encrypt = aes.encrypt_with_aes128_gcm_hex(key, bytes(data, 'utf-8'))
        self.assertIsNotNone(result_encrypt)

        result_decrypt = aes.decrypt_with_aes128_gcm_hex(key, result_encrypt)
    ...
    def test_encrypt_decrypt_aes192_gcm(self):
        ...
        result_encrypt = aes.encrypt_with_aes192_gcm_hex(key, bytes(data, 'utf-8'))
        self.assertIsNotNone(result_encrypt)

        result_decrypt = aes.decrypt_with_aes192_gcm_hex(key, result_encrypt)
    ...
    def test_encrypt_decrypt_aes256_gcm(self):
        ...
        result_encrypt = aes.encrypt_with_aes256_gcm_hex(key, bytes(data, 'utf-8'))
        self.assertIsNotNone(result_encrypt)

        result_decrypt = aes.decrypt_with_aes256_gcm_hex(key, result_encrypt)
    ...
    def test_file_with_decrypt_aes256_gcm(self):
        ...
        with open(encrypted_file_path, 'rb') as input_file:
            decrypted_file_data = aes.decrypt_with_aes256_gcm_hex(key, input_file.read().decode())
