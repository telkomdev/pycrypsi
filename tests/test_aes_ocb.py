...
class TestAESOcb(unittest.TestCase):
    ...
    def test_encrypt_decrypt_aes128_ocb(self):
        ...
        result_encrypt = aes.encrypt_aes128_ocb_hex(key, bytes(data, 'utf-8'))
        self.assertIsNotNone(result_encrypt)

        result_decrypt = aes.decrypt_aes128_ocb_hex(key, result_encrypt)
    ...
    def test_encrypt_decrypt_aes192_ocb(self):
        ...
        result_encrypt = aes.encrypt_aes192_ocb_hex(key, bytes(data, 'utf-8'))
        self.assertIsNotNone(result_encrypt)

        result_decrypt = aes.decrypt_aes192_ocb_hex(key, result_encrypt)
    ...
    def test_encrypt_decrypt_aes256_ocb(self):
        ...
        result_encrypt = aes.encrypt_aes256_ocb_hex(key, bytes(data, 'utf-8'))
        self.assertIsNotNone(result_encrypt)

        result_decrypt = aes.decrypt_aes256_ocb_hex(key, result_encrypt)
